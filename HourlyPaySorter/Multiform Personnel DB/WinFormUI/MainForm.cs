...
namespace WinFormUI
{
    public partial class MainForm : Form
    {
        ...
        private void ascendPayButton_Click(object sender, EventArgs e)
        {
            this.employeeTableAdapter.AscendingPay(this.personnelDataSet.Employee);
        }

        private void descendPaySortButton_Click(object sender, EventArgs e)
        {
            this.employeeTableAdapter.DescendingPay(this.personnelDataSet.Employee);
        }
    }
}
